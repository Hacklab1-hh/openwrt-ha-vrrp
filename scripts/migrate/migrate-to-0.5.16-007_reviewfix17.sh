#!/bin/sh
# Migration script for 0.5.16-007_reviewfix17
#
...
echo "[migrate] applying migration to 0.5.16-007_reviewfix17"
...
echo "[migrate] nothing to do for 0.5.16-007_reviewfix17"
exit 0