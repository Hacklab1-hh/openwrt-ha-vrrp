...
do_migrate(){
  ...
  inf "Dateibewegungen (10→11)…"; apply_file_moves "$FILE_MOVES_MIG"
  inf "UCI Umbenennungen…"; apply_uci_renames "$UCI_RENAMES_MIG"
  inf "UCI Defaults…"; apply_uci_defaults "$UCI_DEFAULTS_MIG"; uci_commit_ha
  inf "Aufräumen…"; apply_trash_list "$TRASH_MIG"
...
do_rollback(){
  ...
  inf "Dateibewegungen (11→10)…"; apply_file_moves "$FILE_MOVES_RB"
  inf "UCI Rückbenennungen…"; apply_uci_renames "$UCI_RENAMES_RB"
  inf "UCI Defaults entfernen…"; unset_uci_keys "$UCI_UNSET_ON_RB"; uci_commit_ha
